...
#
# Relaxation over 1 ns of simulation time at a constant pressure 
# with backbone restraints set to 10 kcal/mol•Å2.
...
binCoordinates output_05.coor
binVelocities  output_05.vel
extendedSystem output_05.xsc
#-----------------------------------------------------------------------
