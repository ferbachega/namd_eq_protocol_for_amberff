...
# This last step of relaxation removes the restraints on the backbone,
# simulates 1 ns of simulation time at a constant pressure.

# Note that the time step is still small (1 fs) since the system is 
# still relaxing and the translation and rotational COM motion is 
# removed every 1000 steps, and that there are no restraints on the system anymore.
...
binCoordinates output_08.coor
binVelocities  output_08.vel
extendedSystem output_08.xsc
#-----------------------------------------------------------------------
...
constraintScaling 0.1         ;# Optional scaling factor for the constraints
